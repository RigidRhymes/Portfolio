...
const Projects = () => {
    return (
        <div className='mb-12 px-6'>
            ...
            <div className='items-center justify-center mb-6 w-full gap-2' style={{display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gridAutoRows: "1fr", alignItems: "stretch"}}>
                {WORKS_ITEMS.map((work, i) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className='relative transform-transition duration-500 ease-in-out hover:scale-105 hover:-translate-y-1 hover:shadow-xl hover:border-2 hover:border-gray-200 hover:rounded-xl'
                        >
