...
const Contact = () => {
    return (
        <div className='px-6 w-full' id="contact">
            <section className='-bg-linear-120   from-[#192540] to-[#274c57] at-top rounded-2xl mb-12 w-full h-84 flex flex-row justify-between' style={{display: "grid", gridTemplateColumns: "1fr 2fr"}}>
                <div className=' flex-wrap px-6'>
                    <div className='mt-4 font-bold text-2xl'>Let&apos;s build the <span className='primary'>next</span> chapter.</div>
                   ...
                   <div className='flex flex-row justify-center gap-4'>
                    ...
                    <div className='justify-center flex w-full mt-2'>
                        <div className='flex flex-col'>
                            ...
                            <textarea className='bg-black mt-2 w-150 px-2 h-32 rounded-md'/>
                        </div>
                    </div>
                    <div className='flex justify-center mb-2'>
                        <button className='w-150 p-2 bgColor rounded-md cursor-pointer text-black'>Send Inquiry</button>
                    </div>
                </div>
            </section>
        </div>
